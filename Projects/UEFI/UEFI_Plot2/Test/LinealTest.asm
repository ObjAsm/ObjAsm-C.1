; ==================================================================================================
; Title:   LinealTest.asm
; Author:  Héctor S. Enrique
; Version: 1.0.0
; Purpose: ObjAsm compilation file for LinealTest object.
...
%SysSetup OOP, NUIOA, LIBOA,DEBUG(WND, INFO, TRACE,"LinealTest")
...
LoadObjectsD .\, .\test\, SimpleTest

LoadObjectsD .\, .\modelo\, modeloC

;Add here the file that defines the object(s) to be included in the library
MakeObjects .\Test\LinealTest
